...
export const LOGIN_URL = `https://accounts.spotify.com/authorize/?client_id=${process.env.REACT_APP_CLIENT_ID}&response_type=token&redirect_uri=${encodeURIComponent(
  REDIRECT_URI
)}&scope=${encodeURIComponent(process.env.REACT_APP_SCOPE)}`
